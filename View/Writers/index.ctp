<div class="writers index">
	...
	<tr>
		...
		<td><?php echo h($writer['Writer']['biography']); ?>&nbsp;</td>
		<td><?php echo h($writer['Writer']['created']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $writer['Writer']['id']), null, __('Are you sure you want to delete # %s?', $writer['Writer']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
